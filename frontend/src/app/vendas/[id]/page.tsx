...
export default function VendaDetalhesPage() {
  ...
  const statusVisual =
    obterStatusVisual(venda.status);
        ...
        <CrudCard>
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Campo
              ...
              valor={formatarCondicaoPagamento(
...
function obterClasseStatusConta(
  status?: string,
) {
  const mapa: Record<string, string> = {
    PENDENTE:
