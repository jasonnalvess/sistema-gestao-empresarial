...
export default function MovimentacoesCaixaPage() {
  ...
  const { data: caixasResponse } = useQuery({
    queryKey: ["caixas-select-movimentacoes"],
        ...
        <CrudCard>
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            ...
            >
              ...
              <option value="CONTA_PAGAR">
                Conta a pagar
              </option>

              <option value="CONTA_RECEBER">
                Conta a receber
              </option>
...
function ReferenciaLink({
  ...
  const contaPagar =
    movimentacao.pagamentoContaPagar
      ?.contaPagar;
  ...
  if (contaPagar) {
    return (
      ...
      >
        Conta a pagar #
        {String(contaPagar.numero).padStart(
          5,
          "0"
        )}
      </Link>
  ...
  const contaReceber =
    movimentacao.recebimentoContaReceber
      ?.contaReceber;
